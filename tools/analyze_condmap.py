...
CFG = {
    ...
    # -----------------------------
    #"cond_nii_tmpl":  "D:/kubota/Data/Model10test/M3_3_nii/{pid}_pred.nii.gz",
    "cond_nii_tmpl":  "D:/kubota/Data/Model10test/ablation_noRank_nii/{pid}_pred.nii.gz",
    ...
    # 出力先
    # -----------------------------
    "out_csv_dir": "D:/Kubota/data/Model10test/csv/ablation_noRank",
    "out_excel": "D:/Kubota/data/Model10test/csv/ablation_noRank/label_summary.xlsx",
